...
function PlayMusic (idx){
	...
	for (i = 1; i < nPlatforms; i++){
		Instantiate (platform, Vector3(-1.2, 0, i * 95), Quaternion.identity);
	}
	
	goal.transform.Translate(Vector3(0,-3,i*95));
}

function GenerateLevel(audioSrc : AudioSource){
